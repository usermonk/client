...
const mergeProps = (s, d, o: OwnProps) => {
  ...
  const isEmpty = !normalRowItems.size
  return {
    destinationPickerIndex: o.destinationPickerIndex,
    isEmpty,
    items: I.List([
      ...(o.headerRows || []),
      // don't show sort bar in empty folders, or destinationPicker, or on
      // mobile.
      ...(isEmpty || isMobile || typeof o.destinationPickerIndex === 'number' ? [] : topBarAsRow(o.path)),
    ])
